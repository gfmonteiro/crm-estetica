...
function RedefinirSenhaForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="card p-6 shadow-sm max-w-sm w-full">
      <p className="mb-4 text-sm text-muted">
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <Suspense fallback={<div className="card p-6 shadow-sm text-center text-sm text-muted">Carregando...</div>}>
          <RedefinirSenhaForm />
        </Suspense>
      </div>
    </div>
